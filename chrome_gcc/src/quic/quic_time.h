 ...
 public:
  ...
  class  Delta {
   public:
    ...
    inline double ToSeconds() const { return time_offset_ / 1000.f / 1000.f; }
    ...
    const int64_t Getint64()const{return time_offset_;};
  ...
  uint64_t GetUint64(){return time_;};
  QuicTime(int64_t time) : time_(time) {}
