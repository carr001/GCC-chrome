...
#include "src/google_cc/network_state_predictor.h"
#include "src/google_cc/delay_based_bwe.h"
#include "src/google_cc/acknowledged_bitrate_estimator_interface.h"
#include "src/google_cc/send_side_bandwidth_estimation.h"
...
class GoogCcNetworkController : public NetworkControllerInterface {
 public:
  ...
  DataRate GetSenderSideDataRate()const;
  DataRate GetReceiverLimit()const;
  DelayBasedBwe::Result recent_result()const{ return recent_result_;};
  absl::optional<DataRate> GetAcknowlegeRate() const{return acknowledged_bitrate_estimator_->bitrate();};
 private:
  ...
  PacerConfig GetPacingRates(Timestamp at_time) const;// add by carr
...
//   std::unique_ptr<NetworkStatePredictor> network_state_predictor_;
  ...
  webrtc::DelayBasedBwe::Result recent_result_;// added by carr
