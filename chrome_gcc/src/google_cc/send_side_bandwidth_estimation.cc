...
SendSideBandwidthEstimation::SendSideBandwidthEstimation()
    : receiver_limit_caps_only_(true),
      lost_packets_since_last_loss_update_(0),
      expected_packets_since_last_loss_update_(0),
      current_target_(DataRate::BitsPerSec(INITIAL_PACING_RATE)),/*changed by carr*/
...
DataRate SendSideBandwidthEstimation::receiver_limit() const {
  return receiver_limit_;
}
